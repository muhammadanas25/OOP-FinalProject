 ...
 * @author acer
 */
public class WomenStock extends javax.swing.JFrame {

    /**
     * Creates new form WomenStock
     */
    public WomenStock() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        TableStocks.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Shirt", "Color", "Fabric", "Pieces", "Unstiched", "Pants", "Price"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WomenStock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WomenStock().setVisible(true);
            }
        });
    }
